        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <motion.div
              ...
              className="flex items-center gap-3"
            >
              <div className="w-10 h-10 bg-pistach-500/20 rounded-flex items-center justify-center w-10 h-10">
            ...
            >
              ...
              <div>
                ...
                <div className="flex gap-3 mt-2">
                  ...
                  >
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                      <path fill="currentColor" d="M22.46 6c-.77.35-1.6.58-2.46.69a4.3 4.3 0 001.88-2.38 6.11 6.11 0 01-1.81.75 4.3 4.3 0 00-7.39 4.13 4.3 4.3 0 01-3.27-1.24 4.3 4.3 0 00-1.5 3.56m0 0a6.1 6.1 0 01-6.55-6.1A6.11 6.11 0 002 6.11c0 1.91.69 3.55 1.8 4.8 2.15.01 4.15-1.18 4.15-2.62C12 8.12 12 5.08 12 3c0-.27.02-.54.06-.8A2.07 2.07 0 015.19 2.23c-.59.21-1.12.55-1.19 1.14-.06.13-.1.26-.1.41 0 .25.07.51.19.71.49.21 1.01.23 1.51.23 1.5 0 1.15-.65 2.1-1.52 2.56-1.09.31-2.29.16-2.86-.08-.57.89-1.1 1.93-1.1 2.98a6.1 6.1 0 015.42 3.58c1.17.01 2.31-.17 3.36-.78z" />
                    </svg>
                  </Link>
                </div>
              </div>
          ...
          <div className="space-y-4">
            ...
            >
              <div className="w-10 h-10 bg-pistach-500/20 rounded-flex items-center justify-center w-10 h-10">
                <svg className="w-5 h-5 text-pistach-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <div>
