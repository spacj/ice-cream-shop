...
export function generateOrganizationSchema() {
  return {
    ...
    '@type': 'Organization',
    'name': 'Gelato Luxe',
    'url': 'https://pistacchio-utrecht.nl',
    'logo': '/logo.png',
    'description': 'Premium Sicilian gelato in Utrecht - Handcrafted daily from the finest pistachio',
    'sameAs': [
      'https://www.facebook.com/profile.php?id=100063785852831&locale=sv_SE',
      'https://www.instagram.com/ijssalonpistacchio/'
    ],
    'contact': {
      '@type': 'ContactPoint',
      'contactType': 'Customer Service',
      'email': 'hello@pistacchio-utrecht.nl',
      'telephone': '+31 (0)6 1234 5678'
    }
  };
}
