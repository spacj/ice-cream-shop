...
export function LocationCard({ 
  ...
  return (
    ...
    >
      <h3 className="font-display text-3xl text-red-600 mb-8">Visit Us</h3>
      ...
      >
        <div className="flex gap-4 items-start">
          ...
          <div>
            ...
            <p className="text-taupe">{address}</p>
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className="flex gap-4 items-start">
          ...
          <div>
            ...
            <p className="text-taupe mb-1">Monday - Friday: {hours.weekday}</p>
            <p className="text-taupe">Saturday - Sunday: {hours.weekend}</p>
          </div>
        </div>
      </motion.div>
...
export function ReviewCard({ 
  ...
  return (
    ...
    >
      ...
      {/* Review Text */}
      <p className="text-taupe leading-relaxed italic">"{text}"</p>
    </motion.div>
  );
}
  ...
  return (
    <section className="py-20 px-4 bg-gradient-to-b from-red-50 to-white">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="text-lg text-taupe mb-4">Rated on</p>
